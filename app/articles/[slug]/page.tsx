...
export default function ArticlePage({ params }: ArticlePageProps) {
  ...
  // Get related articles (same category or featured)
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-[#3E5641] dark:text-white mb-4">{article.title}</h1>
        ...
        <div className="bg-gradient-to-r from-[#FF6700] to-[#FF7D33] rounded-2xl p-8 text-white text-center shadow-lg">
          ...
          <p className="mb-6">Join thousands of satisfied customers on iMoto GT - South Africa's trusted automotive marketplace.</p>
