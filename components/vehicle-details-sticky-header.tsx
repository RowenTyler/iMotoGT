...
export default function VehicleDetailsStickyHeader({
  ...
  return (
    <header className="fixed top-[60px] md:top-[70px] left-0 right-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-md z-49">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-3 flex-shrink-0">
            ...
            >
              <Heart
                className={cn("w-5 h-5", isSaved ? "fill-[#FF6700] text-[#FF6700]" : "text-[#3E5641] dark:text-white")}
              />
            </button>
